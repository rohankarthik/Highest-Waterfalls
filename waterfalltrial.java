...
public class waterfalltrial extends JFrame {
  ...
  //java.net.URL urlprt1 = getClass().getResource("code/tableview.gif");
  JMenuItem attribitem = new JMenuItem("open attribute table",
                            new ImageIcon("code/tableview.gif"));
  //java.net.URL urlprt2 = getClass().getResource("code/Icon0915b.jpg");
  JMenuItem createlayeritem  = new JMenuItem("create layer from selection",
                    new ImageIcon("code/Icon0915b.jpg"));
  //java.net.URL urlprt3 = getClass().getResource("code/promote.gif");
  static JMenuItem promoteitem = new JMenuItem("promote selected layer",
                    new ImageIcon("code/promote.gif"));
  //java.net.URL urlprt4 = getClass().getResource("code/demote.jpg");
  JMenuItem demoteitem = new JMenuItem("demote selected layer",
                    new ImageIcon("code/demote.jpg"));
  //java.net.URL urlprt5 = getClass().getResource("code/print.gif");
  JMenuItem printitem = new JMenuItem("print",new ImageIcon("code/print.gif"));
  //java.net.URL urlprt7 = getClass().getResource("code/addtheme.jpg");
  JMenuItem addlyritem = new JMenuItem("add layer",new ImageIcon("code/addtheme.jpg"));
  //java.net.URL urlprt8 = getClass().getResource("code/delete.jpg");
  JMenuItem remlyritem = new JMenuItem("remove layer",new ImageIcon("code/delete.jpg"));
  
  JMenuItem legenditem = new JMenuItem("Legend Editor",new ImageIcon("g.gif"));
  //java.net.URL urlprt10 = getClass().getResource("code/properties.jpg");
  JMenuItem propsitem = new JMenuItem("Legend Editor",new ImageIcon("code/properties.jpg"));
 ...
 // String s1 = "C:\\ESRI\\MOJ20\\Samples\\Data\\World\\country.shp";
  ...
  //java.net.URL urlprt12 = getClass().getResource("code/print.gif");
  JButton prtjb = new JButton(new ImageIcon("code/print.gif"));
  //java.net.URL urlprt13 = getClass().getResource("code/addtheme.gif");
  JButton addlyrjb = new JButton(new ImageIcon("code/addtheme.gif"));
  //java.net.URL urlprt9 = getClass().getResource("code/pointer.gif");
  JButton ptrjb = new JButton(new ImageIcon("code/pointer.gif"));
  //java.net.URL urlprt14 = getClass().getResource("code/measure_1.gif");
  JButton distjb = new JButton(new ImageIcon("code/measure_1.gif"));
  //java.net.URL urlprt6 = getClass().getResource("code/hotlink.gif");
  JButton hotjb = new JButton(new ImageIcon("code/hotlink.gif"));
  //java.net.URL urlprt15 = getClass().getResource("code/HELP.GIF");
  JButton helpjb = new JButton(new ImageIcon("code/HELP.GIF"));
  ...
  Image bolt = tk.getImage("code/hotlink.gif");  // 16x16 gif file
  Image helper = tk.getImage("code/helper.gif");
...
//	  String region = MyAssign.region;
	  ...
	  String[][]wfall=
			  ...
			  {
			  		{"Angel Falls","1","979 meters","3,212 ft","Venezuela","code/1.jpg"},
			  		{"Tugela Falls","2","948 meters","3,110 ft","South Africa","code/2.jpg"},
			    	{"Three Sisters Falls","3","914 meters","2,999 ft","Peru","code/3.jpg"},
			    	{"Olo'upena Falls","4","900 meters","2,953 ft","US","code/4.jpg"},
			    	{"Yumbilla Falls","5","896 meters","2,940 ft","Peru","code/5.jpg"},
			    	{"Vinnufossen Falls","6","860 meters","2,822 ft","Norway","code/6.jpg"},
			    	{"Balaifossen Falls","7","850 meters","2,789 ft","Norway","code/7.jpg"},
			    	{"Pu'uka'oku Falls","8","840 meters","2,756 ft","United States","code/8.jpg"},
			    	{"James Bruce Falls","9","840 meters","2,756 ft","Canada","code/9.jpg"},
			    	{"Browne Falls","10","836 meters","2,743 ft","New Zealand","code/10.jpg"},
			    	{"Kaieteur Falls","11","822 meters","2,697 ft","Guyana","code/11.jpg"},
			  };
